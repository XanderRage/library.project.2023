...
object in the borrow array.*/
  ...
  /*console.log(getBorrowersForBook({
    id: "5f447132c30e8abe6c988a8b",
    title: "veniam voluptate magna ipsum officia",
    genre: "Historical Fiction",
    authorId: 37,
...
console.log(getTotalNumberOfBorrows("5f446f2ed46724f41c9fc431", books));
*/
/*function getMostCommonBorrower(books) {
    ...
    const mostCommonId = Object.keys(borrowCounts).reduce((mostCommon, id) => {
        return borrowCounts[id] > borrowCounts[mostCommon] ? id : mostCommon;
    });

    return {
        id: mostCommonId,
        count: borrowCounts[mostCommonId]
    };
}
